        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    <?php include view_path('dashboard.usuarios.links'); ?>
            </ul>
    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <!--begin::Row-->
                <?php include view_path('dashboard.usuarios.header'); ?>
                <!--end::Row-->
        ...
        <div class="app-content" id="content_view_parametros">
            <!--begin::Container-->
            <div class="container-fluid">
                <?php include view_path('dashboard.usuarios.content'); ?>
            </div>
            <?php verCargando(); ?>
        </div>
        <!--end::Container-->
...
<!--end::Script-->
<?php include view_path('dashboard.usuarios.scripts'); ?>
</body>
<!--end::Body-->
</html>