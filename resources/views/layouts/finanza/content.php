...
<div class="container-fluid p-0 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <?php include view_path('layouts.finanza.carousel'); ?>
</div>
<!-- Carousel End -->
    ...
    <div class="container">
        <div class="row g-4 align-items-end mb-4">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <img class="img-fluid rounded" src="<?php asset('vendor/finanza/img/about.jpg'); ?>">
            </div>
                ...
                <div class="tab-content w-100">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute rounded w-100 h-100" src="<?php asset('vendor/finanza/img/service-1.jpg'); ?>"
                    ...
                    <div class="tab-pane fade" id="tab-pane-2">
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute rounded w-100 h-100" src="<?php asset('vendor/finanza/img/service-2.jpg'); ?>"
                                         style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="tab-pane fade" id="tab-pane-3">
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute rounded w-100 h-100" src="<?php asset('vendor/finanza/img/service-3.jpg'); ?>"
                                         style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="tab-pane fade" id="tab-pane-4">
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute rounded w-100 h-100" src="<?php asset('vendor/finanza/img/service-4.jpg'); ?>"
                                         style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
