...
class UsuariosController extends Controller
{
    ...
    function index()
    {
        try {
            ...
            return $this->view('dashboard.usuarios.view', $data);
    ...
    public function limit()
    {
        try {
            $limit = $_POST['limit'] ?? 0;
            $data = $this->initData();
            return $this->view('dashboard.usuarios.table', $this->initData($limit));
    ...
    public function refresh()
    {
        try {
            ...
            $data['actualRowquid'] = $this->getActualRowquid();
            return $this->view('dashboard.usuarios.table', $data);
